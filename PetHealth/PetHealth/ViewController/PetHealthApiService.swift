...
public class PetHealthApiService {
    ...
    static let VETERINARY_URL: String = "http://pethealth.azurewebsites.net/veterinaries";
    static let CUSTOMER_URL: String = "http://pethealth.azurewebsites.net/customers";
    static let ADD_PET_URL: String = "http://pethealth.azurewebsites.net/pet/add";
    static let APPOINTMENT_URL: String = "http://pethealth.azurewebsites.net/pets/appointments";
}
